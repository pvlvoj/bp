...
/*********************************************************************
 * <p>The class of {@code AskForTaskCommandHandler} is used to abstractly define
...
public class AskForTaskCommandHandler extends AHandler {
     ...
     * - the logger of the {@link AskForTaskCommandHandler class</p>
     */
    ...
    public AskForTaskCommandHandler(HandlerContainer container) {
    ...
    public boolean handle(IConnection connection, IMessage message) {
        ...
        if(message instanceof AskForTaskCommand) {

            if(connection instanceof C2SConnection) {


                //TODO
                //connection.send(new GiveMeTasksMessage(UserProperties.getInstance().getUserName()));
                return true;
            }
        }
    ...
    public IHandler copy(HandlerContainer container) {
        ...
        return new AskForTaskCommandHandler(container);
    }
