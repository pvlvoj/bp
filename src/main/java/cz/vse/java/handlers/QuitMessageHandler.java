...
/*********************************************************************
 * <p>The class of {@code QuitMessageHandler} is used to abstractly define
 ...
 */
public class QuitMessageHandler extends AHandler {
     ...
     * - the logger of the {@link QuitMessageHandler class</p>
     */
    ...
    public QuitMessageHandler(HandlerContainer container) {
    ...
    public boolean handle(IConnection connection, IMessage message) {
        ...
        if(message instanceof QuitMessage) {
            ...
            ((QuitMessage) message).execute(connection);
            return true;
        }
        return false;
    }
    ...
    public IHandler copy(HandlerContainer container) {
        ...
        return new QuitMessageHandler(container);
    }
