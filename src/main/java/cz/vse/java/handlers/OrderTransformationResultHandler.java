...
/*********************************************************************
 * <p>The class of {@code OrderTransformationResultHandler} is used to abstractly define
 ...
 */
public class OrderTransformationResultHandler extends AHandler {
     ...
     * - the logger of the {@link OrderTransformationResultHandler class</p>
     */
    ...
    public OrderTransformationResultHandler(HandlerContainer container) {
    ...
    public boolean handle(IConnection connection, IMessage message) {
        ...
        if(message instanceof OrderTransformationResult) {

            connection.send(new UniqueOrderIdentRequest());
    ...
    public IHandler copy(HandlerContainer container) {
        ...
        return new OrderTransformationResultHandler(container);
    }
