...
/*********************************************************************
 * <p>The class of {@code ProductByIDContainerHandler} is used to abstractly define
...
public class ProductByIDContainerHandler extends AHandler {
     ...
     * - the logger of the {@link ProductByIDContainerHandler class</p>
     */
    ...
    public ProductByIDContainerHandler(HandlerContainer container) {
    ...
    public boolean handle(IConnection connection, IMessage message) {
        ...
        if(message instanceof ProductByIDContainer) {

            System.out.println(((ProductByIDContainer) message).getContent().toString());
            //TODO
            return true;
        }
    ...
    public IHandler copy(HandlerContainer container) {
        ...
        return new ProductByIDContainerHandler(container);
    }
