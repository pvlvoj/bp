...
/*********************************************************************
 * <p>The class of {@code WrongMessage} is used to abstractly define
...
public class WrongMessage extends AProblemSolver implements IProblemSolver {
     ...
     * - the logger of the {@link WrongMessage class</p>
     */
    ...
    public WrongMessage(ESolveMethod method) {

        super(EErrorType.WRONG_MESSAGE);
        this.method = method;
    }
        ...
        if(super.check(type)) {
            ...
            switch (method) {
                ...
                case CLOSE: {
                    ...
                    LOG.log(Level.SEVERE, "Closing connection.");
                    connection.close();
                    return true;
                }
                default: {
                    LOG.log(Level.SEVERE, "UNSUPPORTED METHOD!");
                }
            }
        }
