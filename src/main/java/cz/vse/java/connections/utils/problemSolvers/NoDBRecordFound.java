...
/*********************************************************************
 * <p>The class of {@code NoDBRecordFound} is used to abstractly define
...
public class NoDBRecordFound extends AProblemSolver {
     ...
     * - the logger of the {@link NoDBRecordFound class</p>
     */
    ...
    public NoDBRecordFound(ESolveMethod method) {

        super(EErrorType.NO_DB_RESULT_FOUND);
        this.method = method;
    }
    ...
    public boolean solve(IConnection connection, EErrorType type) {
        ...
        if(super.check(type)) {
            ...
            LOG.log(Level.SEVERE, "Solving " + type.name() + " using " + method.getShortDesc() + " method.");
            ...
            switch (method) {
                ...
                default: {
                    ...
                    LOG.log(Level.SEVERE, "Not suitable solving method: '" + method.getShortDesc() + "'!");
                }
            }
        }
