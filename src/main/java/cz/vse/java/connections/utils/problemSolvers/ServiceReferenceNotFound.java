...
/*********************************************************************
 * <p>The class of {@code ServiceReferenceNotFound} is used to abstractly define
 ...
 */
public class ServiceReferenceNotFound extends AProblemSolver implements IProblemSolver {
     ...
     * - the logger of the {@link ServiceReferenceNotFound class</p>
     */
    ...
    public ServiceReferenceNotFound(ESolveMethod method) {

        super(EErrorType.SERVICE_REFERENCE_NOT_FOUND);
        this.method = method;
    }
    ...
    public boolean solve(IConnection connection, EErrorType type) {
        ...
        if(super.check(type)) {
            ...
            LOG.log(Level.INFO, "Solving " + this.getSolving() + " using " + method.getShortDesc() + " method.");
            ...
            switch (this.method) {
                ...
                default: {
                    ...
                    LOG.log(Level.SEVERE, "Method of " + method.getShortDesc() + " is not supported for this kind of problem!");
