...
/*********************************************************************
 * <p>The class of {@code WrongFingerPrint} is used to abstractly define
 ...
 */
public class WrongFingerPrint extends AProblemSolver implements IProblemSolver {
     ...
     * - the logger of the {@link WrongFingerPrint class</p>
     */
    ...
    public WrongFingerPrint(ESolveMethod method) {

        super(EErrorType.WRONG_FINGERPRINT);
        this.method = method;
    }
